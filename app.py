...
if __name__ == "__main__":
    llama_path = "/content/Multimodal-GPT/checkpoints/llama-7b-hf"
    open_flamingo_path = "/content/Multimodal-GPT/checkpoints/OpenFlamingo-9B-deprecated/checkpoint.pt"
    finetune_path = "/content/Multimodal-GPT/checkpoints/mmgpt-lora-v0-release.pt"
